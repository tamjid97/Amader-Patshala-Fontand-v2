        ...
        <div className="grid grid-cols-1 gap-10 pb-12 md:grid-cols-3 md:gap-8">
          ...
          <div className="space-y-5">
            ...
            <div className="flex items-center gap-3 pt-2">
              <a href="https://www.facebook.com/share/1HP9NHhA3P" className="flex h-9 w-9 items-center justify-center rounded-full bg-white/60 text-emerald-800 shadow-sm transition-all hover:bg-emerald-600 hover:text-white dark:bg-black/20 dark:text-emerald-300 dark:hover:bg-emerald-600 dark:hover:text-white">
                <svg className="size-4" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </a>
              <a href="https://www.youtube.com/@Roots_Of_Biology" className="flex h-9 w-9 items-center justify-center rounded-full bg-white/60 text-emerald-800 shadow-sm transition-all hover:bg-emerald-600 hover:text-white dark:bg-black/20 dark:text-emerald-300 dark:hover:bg-emerald-600 dark:hover:text-white">
                <svg className="size-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="space-y-5 md:px-8">
            ...
            <ul className="space-y-3">
              {["Home", "Dashboard", "Batch Time", "Material", "Result"].map((item) => (
                <li key={item}>
                  <Link 
                    href="#" 
